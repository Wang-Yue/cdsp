 ...
 * @param out_mask Output pointer pointing inside buf to the 4-byte masking key (NULL if unmasked).
 * @param out_opcode Output for the 4-bit opcode (e.g. 0x01 for text, 0x08 for close).
 * @return true if a complete and valid frame header is present in the buffer, false otherwise.
 */
