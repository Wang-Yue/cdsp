...
alsa_sample_format_t alsa_sample_format_from_string(const char *str) {
  ...
  if (strcmp(str, "S24_3_LE") == 0)
    return ALSA_SAMPLE_FORMAT_S24_3_LE;
  if (strcmp(str, "S24_4_LE") == 0)
...
audio_backend_type_t audio_backend_type_from_string(const char *str) {
...
#endif
#if defined(ENABLE_PIPEWIRE)
  if (strcmp(str, "PipeWire") == 0)
    return AUDIO_BACKEND_TYPE_PIPEWIRE;
#endif
#if defined(ENABLE_WASAPI)
  if (strcmp(str, "Wasapi") == 0)
    return AUDIO_BACKEND_TYPE_WASAPI;
#endif
#if defined(ENABLE_ASIO)
  if (strcmp(str, "Asio") == 0)
  ...
  if (strcmp(str, "SignalGenerator") == 0)
...
sdm_filter_t sdm_filter_from_string(const char *str) {
  ...
  if (strcmp(str, "clans-4") == 0)
    return SDM_FILTER_CLANS4;
  if (strcmp(str, "sdm-4") == 0)
    return SDM_FILTER_SDM4;
  if (strcmp(str, "clans-5") == 0)
    return SDM_FILTER_CLANS5;
  if (strcmp(str, "sdm-5") == 0)
    return SDM_FILTER_SDM5;
  if (strcmp(str, "clans-6") == 0)
    return SDM_FILTER_CLANS6;
  if (strcmp(str, "sdm-6") == 0)
    return SDM_FILTER_SDM6;
  if (strcmp(str, "clans-7") == 0)
    return SDM_FILTER_CLANS7;
  if (strcmp(str, "sdm-7") == 0)
    return SDM_FILTER_SDM7;
  if (strcmp(str, "clans-8") == 0)
    return SDM_FILTER_CLANS8;
  if (strcmp(str, "sdm-8") == 0)
    return SDM_FILTER_SDM8;
  return SDM_FILTER_INVALID;
}
...
binary_sample_format_t file_sample_format_from_string(const char *str) {
  ...
  if (strcmp(str, "S24_4_RJ_LE") == 0)
    return BINARY_SAMPLE_FORMAT_S24_4_RJ_LE;
  if (strcmp(str, "S24_4_LJ_LE") == 0)
