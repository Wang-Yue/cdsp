...
dsp_session_get_processing_params(dsp_session_t *session);
...
dsp_session_get_stop_reason(const dsp_session_t *session);
 ...
 */
processing_stop_reason_t
dsp_session_stop_and_free(dsp_session_t *session,
