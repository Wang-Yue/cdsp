 ...
 */
double
processing_parameters_get_resampler_load(const processing_parameters_t *params);
...
processing_parameters_get_target_volume(const processing_parameters_t *params) {
 ...
 */
static inline void
processing_parameters_set_target_volume(processing_parameters_t *params,
                                        double value) {
 ...
 */
static inline void
processing_parameters_set_current_volume(processing_parameters_t *params,
                                         double value) {
 ...
 */
static inline bool
processing_parameters_is_muted(const processing_parameters_t *params) {
 ...
 */
static inline void
processing_parameters_set_muted(processing_parameters_t *params, bool value) {
 ...
 */
static inline bool
processing_parameters_toggle_muted(processing_parameters_t *params) {
