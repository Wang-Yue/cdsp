...
make CC="$CC" \
     ...
     USE_LIBDISPATCH=1 \
     IS_DARWIN=0 \
     CFLAGS="--sysroot=$SYSROOT -isystem $SYSROOT/usr/include/aarch64-linux-gnu -isystem $SYSROOT/usr/include/dbus-1.0 -isystem $SYSROOT/usr/lib/aarch64-linux-gnu/dbus-1.0/include -isystem $SYSROOT/usr/include/pipewire-0.3 -isystem $SYSROOT/usr/include/spa-0.2 -isystem $SYSROOT/usr/libexec/swift/lib/swift -D_REENTRANT -O3 -std=c11 -DCDSP_BUILD_SHARED -Wall -Wextra -DENABLE_ALSA -DENABLE_PIPEWIRE -DENABLE_FFTW -DUSE_LIBDISPATCH -D_GNU_SOURCE -I. -I./Filters -I./Audio -I./Config -I./FFT -I./Mixer -I./Resampler -I./Processors -I./DoP -I./Pipeline -I./Engine -I./Server -I./Backend -I./Logging -I./Utils" \
