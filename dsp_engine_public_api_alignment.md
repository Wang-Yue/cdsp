...
| N/A *(PCM Waveform)* | Stateful | `bool (*get_samples)(void* ctx, ...)` | [`cdsp_get_samples(engine, ..., &samples, &err)`](Public/processing.h#L98) | Caller buffers | [`Public/processing.h`](Public/processing.h) | Fetches raw PCM audio sample buffers into caller arrays. |
...
| `GetVuLevels` / `GetSignalLevels` | Stateful | `bool (*get_vu_levels)(void* ctx, ...)` | [`cdsp_get_vu_levels(engine, &vu)`](Public/signal_levels.h#L19) | Caller buffers | [`Public/signal_levels.h`](Public/signal_levels.h) | Snapshot of RMS and Peak signal levels into caller arrays. |
| `GetSpectrum` | Stateful | `bool (*get_spectrum)(void* ctx, ...)` | [`cdsp_get_spectrum(engine, side, channel_ptr, ..., &spec)` ](Public/spectrum.h#L33) | Caller buffers | [`Public/spectrum.h`](Public/spectrum.h) | Computes FFT logarithmic spectrum into caller arrays. |
| `GetVolume` / Main Fader | Stateful | `float (*get_fader_volume)(void* ctx, ...)` | [`cdsp_get_volume(engine)`](Public/fader.h#L14) | N/A | [`Public/fader.h`](Public/fader.h) | Shorthand queries volume in dB for main fader. |
| `SetVolume` / Main Fader | Stateful | `void (*set_volume)(void* ctx, ...)` | [`cdsp_set_volume(engine, db, instant)`](Public/fader.h#L22) | N/A | [`Public/fader.h`](Public/fader.h) | Shorthand sets volume in dB for main fader. |
| `GetMute` / Main Fader | Stateful | `bool (*get_fader_mute)(void* ctx, ...)` | [`cdsp_get_mute(engine)`](Public/fader.h#L29) | N/A | [`Public/fader.h`](Public/fader.h) | Shorthand queries mute boolean for main fader. |
| `SetMute` / Main Fader | Stateful | `void (*set_fader_mute)(void* ctx, ...)` | [`cdsp_set_mute(engine, mute)`](Public/fader.h#L36) | N/A | [`Public/fader.h`](Public/fader.h) | Shorthand toggles mute state for main fader. |
| `GetFaderVolume` / `GetVolume` | Stateful | `float (*get_fader_volume)(void* ctx, ...)` | [`cdsp_get_fader_volume(engine, fader)`](Public/fader.h#L44) | N/A | [`Public/fader.h`](Public/fader.h) | Queries volume gain setting in dB for a fader. |
| `GetFaderMute` / `GetMute` | Stateful | `bool (*get_fader_mute)(void* ctx, ...)` | [`cdsp_get_fader_mute(engine, fader)`](Public/fader.h#L62) | N/A | [`Public/fader.h`](Public/fader.h) | Queries mute state boolean for a fader. |
| `SetFaderVolume` / `SetVolume` | Stateful | `void (*set_fader_volume)(void* ctx, ...)` | [`cdsp_set_fader_volume(engine, fader, db, instant)`](Public/fader.h#L53) | N/A | [`Public/fader.h`](Public/fader.h) | Sets volume gain setting in dB for a fader. |
| `SetFaderMute` / `SetMute` | Stateful | `void (*set_fader_mute)(void* ctx, ...)` | [`cdsp_set_fader_mute(engine, fader, mute)`](Public/fader.h#L70) | N/A | [`Public/fader.h`](Public/fader.h) | Toggles mute state for a fader. |
