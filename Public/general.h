 ...
 *
 * All returned string pointers point to static memory. The arrays themselves are
 * allocated and must be freed by calling cdsp_free_device_types.
 *
...
/**
 * @brief Poll the engine for background tasks, state synchronization, and status updates.
 * @param engine Pointer to the engine.
 */
 ...
 * @param level_str Name of the log level (e.g. "trace", "debug", "info", "warn", "error").
 */
