...
TEST(check_lr) {
  int fs = 48000;
  biquad_combo_config_t okconf = {.type =
  ...
  biquad_combo_config_t bad1 = {.type =
                                    BIQUAD_COMBO_TYPE_LINKWITZ_RILEY_HIGHPASS,
                                .freq = 1000.0,
                                .has_freq = true,
                                .order = 5,
  ...
  biquad_combo_config_t bad2 = {.type =
                                    BIQUAD_COMBO_TYPE_LINKWITZ_RILEY_HIGHPASS,
                                .freq = 1000.0,
                                .has_freq = true,
                                .order = 0,
  ...
  biquad_combo_config_t bad3 = {.type =
                                    BIQUAD_COMBO_TYPE_LINKWITZ_RILEY_HIGHPASS,
                                .freq = 0.0,
                                .has_freq = true,
                                .order = 2,
  ...
  biquad_combo_config_t bad4 = {.type =
                                    BIQUAD_COMBO_TYPE_LINKWITZ_RILEY_HIGHPASS,
                                .freq = 25000.0,
                                .has_freq = true,
                                .order = 2,
...
TEST(ComboCanonMatchesStagesRunOneAtATime) {
  int fs = 44100;
  biquad_combo_config_t lr_conf = {.type =
