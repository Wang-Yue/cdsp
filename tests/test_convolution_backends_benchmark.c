...
TEST(Convolution_Performance_Chunk_Size_Sweep) {
  ...
  printf(
      ...
      "Precision f64)\n");
  printf(" Compares throughput and per-chunk latency across different block "
         "sizes\n");
  printf(
      "========================================================================"
      "=================================================\n");
...
TEST(RealFFT_PowerOfTwo_Performance_Sweep) {
  printf(
      "\n======================================================================"
      "===================================================\n");
  printf(" REAL FFT (POWER-OF-TWO) ROUNDTRIP BENCHMARK: CDSP (FFTW3) vs Rust "
         "(realfft/RustFFT)\n");
  printf(
  ...
  printf(
      "========================================================================"
      "=================================================\n");
  printf(" Length |   CDSP FFTW3 (f64)  |    Rust (realfft)   |  CDSP vs Rust "
         "Speedup \n");
  printf(
...
TEST(RealFFT_Resampler_NonPowerOfTwo_Sweep) {
  ...
  printf(
      ...
      "(realfft/RustFFT)\n");
  printf(" Critical composite/prime-factored FFT lengths used in Synchronous "
         "Resampling (f64)\n");
  printf(
      " Monotonic Timer: 5-trial median with warm-up runs and anti-DCE memory "
      "barriers\n");
  printf(
      "========================================================================"
      "=================================================\n");
  printf(" Length | Resampler Context / Sample Rates |  CDSP FFTW3 (f64)   |   "
