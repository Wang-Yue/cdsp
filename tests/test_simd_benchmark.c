...
TEST(SIMD_Benchmark) {
  ...
  printf(
      "========================================================================"
      "=========================================================\n");
  printf(" CDSP SIMD Benchmark: Speedup over Compiler-Optimized C (vDSP / "
         "BLAS)\n");
  ...
  printf(
      "-------------------------------+----------------+----------------+------"
      "----------+----------------+----------------+---------------\n");
  printf("Note: Speedup > 1.00x means library out-performed pure C. 'null' "
